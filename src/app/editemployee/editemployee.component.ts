...
export class EditemployeeComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.actRoute.paramMap.subscribe((params: ParamMap) => {
      ...
      this.employee = this.empService.getEbyID(this.employeeId).subscribe(
        (data) => {this.employee = data; console.log(data);
          this.editemployeeForm = this.fb.group({
            ...
            dept: [this.employee.dept, [Validators.required, Validators.minLength(3)]]
          });
        },
  ...
  get dept(){
    return this.editemployeeForm.get('dept');
  }
